...
namespace dinkydodoukwhm\whm\migrations;
...
class Install extends Migration
{
   ...
   /**
    ...
    protected function createTables()
    {
        ...
        $tableSchema = Craft::$app->db->schema->getTableSchema('{{%whm_whmrecord}}');
        if ($tableSchema === null) {
            $tablesCreated = true;
            $this->createTable(
                '{{%whm_whmrecord}}',
    ...
    {
        $this->addForeignKey(
            $this->db->getForeignKeyName('{{%whm_whmrecord}}', 'siteId'),
            '{{%whm_whmrecord}}',
            'siteId',
            '{{%sites}}',
            'id',
    ...
    {
        $this->dropTableIfExists('{{%whm_whmrecord}}');
    }
}
